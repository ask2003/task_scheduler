Using Systick Handler and PendSv in STM32F4xx, a Round - Robin based task scheduler is made where four tasks are pre-empted every 1s, 500ms, 250ms, 125ms. On-board Led toggling take place.
